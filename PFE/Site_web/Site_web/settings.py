...
ALLOWED_HOSTS = ['localhost','127.0.0.1', '89.168.56.171','192.168.10.217']
...
# Channels layer (exemple avec in-memory layer pour développement)
CHANNEL_LAYERS = {
    "default": {
...
# Liste des finders utilisés pour rechercher les fichiers statiques
STATICFILES_FINDERS = [
    'django.contrib.staticfiles.finders.FileSystemFinder',
    'django.contrib.staticfiles.finders.AppDirectoriesFinder',
]
# Configuration pour whitenoise (que vous avez déjà installé)
# MIDDLEWARE = [
#     'django.middleware.security.SecurityMiddleware',
#     'whitenoise.middleware.WhiteNoiseMiddleware',  # Ajoutez ce middleware
#     # ...autres middleware...
# ]
